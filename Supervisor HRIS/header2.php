...
<body>
        ...
        <div class="sidebars" style="margin-top: -30px;">
            <ul class="first-ul">
                ...
                <li><a href="attendance_visor.php" class="hoverable"><div><span class="fa-regular fa-clock"></span>ATTENDANCE</div></a></li>

                <li><a href="#" class="timekeep-dd hoverable"><div><span class="fa-solid fa-wallet"></span>REQUEST</div><span class="fa-solid fa-chevron-right"></span></a>
                ...
                <li><a href="employee_list.php" class="hoverable"><div><span class="fa-solid fa-user-group"></span>EMPLOYEES</div></a></li>
        
                </li>

                <li><a href="#" class="hoverable employees-dd"><div><span class="fa-regular fa-envelope"></span>REPORTS</div><span class="fa-solid fa-chevron-right"></span></a>
                ...
                <li><a href="#" class="hoverable"><div><span class="fa-solid fa-building-user"></span>MANPOWER</div></a></li>
