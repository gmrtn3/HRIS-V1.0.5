            ...
            if($day_of_week === 'Monday'){
                ...
                if (mysqli_num_rows($wfhRun) === 0) {
                    ...
                    if ($query_run) {
                        ...
                        $selectWFH = "SELECT * FROM wfh_tb WHERE id= '$column_id' AND empid = '$EmpMail'";  
                ...
                if (mysqli_num_rows($wfhRun) === 0) {
                    echo "UPDATE wfh_tb SET `status` ='Approved' WHERE `id`='$column_id'";
                    $sql = "UPDATE wfh_tb SET `status` ='Approved' WHERE `id`='$column_id'";
                    $query_run = mysqli_query($conn, $sql);
...
if(isset($_POST['reject_btn']))
{
    ...
    $status_ot = $row_wfh['status'];
            ...
            if($day_of_week === 'Monday'){
                ...
                if (mysqli_num_rows($wfhRun) === 0) {
                    $sql = "UPDATE wfh_tb SET `status` ='Rejected' WHERE `id`='$column_id'";
                    $query_run = mysqli_query($conn, $sql);
