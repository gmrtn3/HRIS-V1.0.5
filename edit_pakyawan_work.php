...
?>
    ...
    <form action="">
        <div class="pakyawan-container shadow" style="width: 80%; position: absolute; left: 18%; top: 14%; height: 82%; background-color: #fff; border-radius: 0.625em;">
            ...
            <div class="pakyawan-information mt-3" style=" width: 96%; margin:auto;">
                ...
                <div class="row">
                    <div class="form-group col">
                      ...
                      <input class="form-control" type="text" name="empid" id="" value="<?php echo $rows['company_code_name']; echo " - "; echo $row['empid'] ?>" readonly>
                    </div>
                  <?php 
                  include 'config.php';
