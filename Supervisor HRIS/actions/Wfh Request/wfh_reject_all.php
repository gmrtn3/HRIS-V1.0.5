...
if (isset($_POST['reject_all_btn'])){
  ...
  $wfh_reject_marks = $_POST['wfh_reject_marks'];
      ...
      if($status_wfh === 'Pending'){
                $day_of_week = date('l', strtotime($date_wfh)); // get the day of the week using the "l" format specifier
                        ...
                        if ($day_of_week === 'Monday') {
                            $UpdateWFH = "UPDATE wfh_tb SET `status` = 'Rejected', `wfh_action_taken` = '$currentDateTime', `wfh_remarks` = '$wfh_reject_marks' WHERE `empid` = '$employeeid' AND `id` = '$wfh_id' AND `status` = 'Pending'";
                            $RunWFH = mysqli_query($conn, $UpdateWFH);
                            if ($RunWFH){
                              $msg .= "You Rejected the Request for employee ID: $employeeid on $date_wfh<br>";
                            }else{
                              $error = true;
                              $msg .= "Failed to reject the employee ID: $employeeid on $date_wfh<br>";
                            }
                        ...
                        if ($error) {
                          ...
                          foreach ($ApprovedArray as $ApprovedEmail) {
                              ...
                              <p>Your wfh request on $date_wfh is rejected</p>
                              </body>
                              </html>
                              ";
